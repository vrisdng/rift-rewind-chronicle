		...
		<div className="w-full h-screen flex flex-col items-center justify-center lol-bg-subtle relative overflow-hidden">
			...
			<div className="text-center space-y-12 animate-fade-in relative z-10 max-w-4xl mx-auto w-full px-8">
				...
				<div className="space-y-4">
					<h1
						className="lol-heading text-7xl sm:text-8xl md:text-9xl text-[#C8AA6E]"
						style={{ textShadow: "0 0 60px rgba(200, 170, 110, 0.4)" }}
					>
						2025
					</h1>
					<p className="lol-subheading text-gray-400">Season Rewind</p>
				</div>
				...
				<div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl mx-auto pt-4">
					...
					<div className="text-center">
						<div className="text-4xl font-bold text-[#C8AA6E] lol-body mb-2">
							{playerData.winRate.toFixed(0)}%
						</div>
						<div className="lol-subheading text-gray-500 text-xs">Victory</div>
					</div>
					<div className="text-center">
						<div className="text-3xl font-bold text-white lol-body mb-2 truncate">
